# This is a cluster plot based on recurring payment and down payment based on db scan algorithm.
...
while True:
    try:
        ...
        user_input = input("Please enter a number in the given range:")
        ...
        if user_input > 0:
            ...
            dbscan = DBSCAN()
            # Algorithm to predict and cluster all points based on density.
            ...
            plt.title('DB Scan Cluster Plot for ' + user_key)
            plt.show()
